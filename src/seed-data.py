...
try:
    ...
    if connection.is_connected():
        ...
        cursor.execute("insert into employee(Emp_ID, Region_ID, Emp_Lname, Emp_Fname, EMP_Hiredate)"
                       "values (501,"
        ...
        cursor.execute("insert into employee(Region_ID, Emp_Lname, Emp_Fname, EMP_Hiredate) values"
                       "((select Region_ID from region where Region_Name = 'NW'),"
        ...
        cursor.execute("insert into customer(Cus_ID, Region_ID, Cus_Name, Cus_Phone)"
                       "value"
                       "(101, "
                       "(select Region_ID from region where Region_Name = 'NW'), "
                       "'See Rocks', "
        ...
        cursor.execute("insert into project(Proj_ID, Cus_ID, Emp_ID, Proj_Date, Proj_Descrpt, Proj_EstDateSt, Proj_EstDateEnd, Proj_EstBudget, Proj_ActDateSt, Proj_ActDateEnd, Proj_ActCost)"
                       "value"
                       "(1,"
        ...
        cursor.execute("insert into task(Proj_ID, Task_Info, Task_DateSt, Task_DateEnd) values"
        ...
        cursor.execute("insert into task_skills(Task_ID, Skill_ID, TS_Qty) values"
        ...
        cursor.execute("insert into assign(Emp_ID, Asn_DateSt, Asn_DateEnd, TS_ID) values"
        ...
        cursor.execute("insert into bill(Bill_ID, Bill_Date, Proj_ID) values"
                       "('201', '2014/03/15', '1')")

        connection.commit()

        cursor.execute("insert into worklog(Asn_ID, WL_Date, WL_Hours, Bill_ID) values"
        ...
        cursor.execute("insert into worklog(Asn_ID, WL_Date, WL_Hours) values"
                       "('105', '2014/03/22', '40'),"
                       "('106', '2014/03/22', '40'),"
                       "('110', '2014/03/22', '12'),"
                       "('111', '2014/03/22', '12'),"
